        ...
        <div className="flex justify-center items-center">
          <div className="flex flex-col items-center">
            ...
            <div className="w-15 h-15 flex items-center justify-center">
              <img 
                src="/src/assets/icons/FO4HealthConditionIcons/icon_condition_head_1.svg" 
                alt="Character Head"
            ...
            <div className="w-24 h-32 flex items-center justify-center -mt-2">
              <img 
                src="/src/assets/icons/FO4HealthConditionIcons/icon_condition_body_0.svg" 
                alt="Character Body"
                className="w-full h-full object-contain status-icon"
              />
            </div>
                      ...
                      <div className="flex items-center gap-2">
                        <div className="w-4 h-4 flex items-center justify-center">
                          {contributor.itemType === 'WEAPON' && (
                            <img 
                              src="/src/assets/icons/FO4InvPageIcons/icon_104.svg" 
                              alt="Weapon"
                              className="w-full h-full object-contain status-icon"
                            />
                          )}
                          {contributor.itemType === 'APPAREL' && (
                            <img 
                              src="/src/assets/icons/FO4InvPageIcons/icon_36.svg" 
                              alt="Apparel"
                              className="w-full h-full object-contain status-icon"
                            />
                          )}
                          {contributor.itemType !== 'WEAPON' && contributor.itemType !== 'APPAREL' && (
                            <img 
                              src="/src/assets/icons/FO4InvPageIcons/icon_20.svg" 
                              alt="Temporary"
                              className="w-full h-full object-contain status-icon"
                            />
                          )}
