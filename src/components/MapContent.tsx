...
const MapContent: React.FC = () => {
  ...
  return (
    <Content>
      ...
      >
        <img 
          src="/src/assets/icons/FO4MapMarkers/icon_3.svg" 
      ...
      <div className="space-y-3 mb-8">
        <div className="flex items-center justify-center gap-3">
          <div className="w-5 h-5 flex items-center justify-center">
            <img 
              src="/src/assets/icons/FO4StatsPageIcons/icon_74.svg" 
              alt="Radiation"
              className="w-full h-full object-contain map-icon"
            />
          </div>
        ...
        <div className="flex items-center justify-center gap-3">
          <div className="w-5 h-5 flex items-center justify-center">
            <img 
              src="/src/assets/icons/FO4StatsPageIcons/icon_76.svg" 
              alt="Temperature"
              className="w-full h-full object-contain map-icon"
            />
          </div>
        ...
        <div className="flex items-center justify-center gap-3">
          <div className="w-5 h-5 flex items-center justify-center">
            <img 
              src="/src/assets/icons/FO4StatsPageIcons/icon_104.svg" 
              alt="Signal"
              className="w-full h-full object-contain map-icon"
            />
          </div>
