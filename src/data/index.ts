...
export const perks: Perk[] = [
  { 
    name: "Redis Ranger", 
    icon: "/src/assets/icons/FO4SpecialIcons/icon_intelligence_1.svg", 
  ...
  { 
    ...
    icon: "/src/assets/icons/FO4DataPageIcons/icon_4.svg", 
  ...
  { 
    ...
    icon: "/src/assets/icons/FO4StatsPageIcons/icon_100.svg", 
  ...
  { 
    ...
    icon: "/src/assets/icons/FO4InvPageIcons/icon_122.svg", 
  ...
  { 
    name: "Docker Dweller", 
    icon: "/src/assets/icons/FO4PipboyMenuIcons/icon_14.svg", 
  ...
  { 
    name: "React Ronin", 
    icon: "/src/assets/icons/FO4SpecialIcons/icon_intelligence_3.svg", 
